...
class STT(stt.STT):
    ...
    async def start(self):
        ...
        connect_params = {
            ...
            "encoding": "linear16",
            "sample_rate": "16000",
            # NOTE: filler_words is NOT supported by AsyncV2Client.connect() in this SDK version.
            # Filler word counting is handled via regex in interview_agent.py on_final_transcript.
        }
